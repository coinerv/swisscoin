...
uint256 hashGenesisBlock("0xe72ec2a688867b0acbe6fe34081ce0fbfc32a11aaee5bf8f222200fee17da563");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // swisscoin: starting difficulty is 1 / 2^12
...
{
    // swisscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // swisscoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // swisscoin: 3.5 days
static const int64 nTargetSpacing = 150; // swisscoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // swisscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // swisscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // swisscoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x6cf452d90622e1ac7866e82ef2cbc65b786683d138f7214c45681bbf1b9aebe1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e2cc9306e4181d9f3369a554ddc23b5f5310fa2446e8a3f79e3f872f4260511db8229458b350e4137fff5ef760579139f64b32d4959c557f842c69cea50e5e973a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1454368186;
        block.nBits    = 504365644;
        block.nNonce   = 2362739588;

        if (fTestNet)
        {
            block.nTime    = 1454368186;
            block.nNonce   = 1336354356;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x22c0cfe0d8c1d18ffb072813a93f306fb16acd8df85aea85a0238cd524edc425"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // swisscoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("swisscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("swisscoinMiner : ProcessBlock, block not accepted");
    }
